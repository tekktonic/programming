...
#define SWIG_contract_assert(expr, msg) if(!(expr)) {failwith(msg);} else
    ...
    extern mlsize_t caml_array_length( CAML_VALUE arr );
...
static int _swig_wrap_SDL_INIT_EVERYTHING = 0x00000031;
SWIGEXT CAML_VALUE _wrap_SDL_INIT_EVERYTHING(CAML_VALUE args) {
  CAML_VALUE swig_result;
  
  {
    swig_result = caml_val_int(_swig_wrap_SDL_INIT_EVERYTHING);
  }
...
SWIGEXT CAML_VALUE _wrap_SDL_InitSDL2 (CAML_VALUE args)
{
  CAMLparam1(args);
